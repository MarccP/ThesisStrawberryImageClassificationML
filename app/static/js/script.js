	...
	xhr.onload = function (e) {
		if (this.readyState === 4) {
			...
			if (response['result'] == `extra_class`) {
				el(
					'result2'
				).innerHTML = `Strawberry Image uploaded is an Excellent Quality Product!`;
				el(
					'customers'
				).innerHTML = `Recommendation : Strawberries are of great quality with ensured taste and vitamins, recommended to be bought at a higher price then average.
                                          Strawberries show only good traits with no blemishes and bruises.
                                          Note: Only buy if needed or if financially stable.`;
				el(
					'vendors'
				).innerHTML = `Recommendation : For Vendor, The Strawberry is a Excellent Quality`;
				el(
					'farmers'
				).innerHTML = `Recommendation : Strawberries are of great quality show few imperfections and should be offered at a greater price than the normal.
				...
				el(
					'result2'
				).innerHTML = `Strawberry Image uploaded is an Good Quality Product!`;

				el(
					'customers'
				).innerHTML = `Recommendation : Strawberries are of good quality worth buying at an average price.
                                          Strawberries show good traits and characteristics with only small blemishes.`;

				el(
					'vendors'
				).innerHTML = `Recommendation : Strawberries are of good quality worth marketing at a average to semi-high price and recommended to mark-up at a average price.
				...
				el(
					'farmers'
				).innerHTML = `Recommendation : Strawberries are of good quality and are ready to be harvested and imported with less supervision.
				...
				el(
					'result2'
				).innerHTML = `Strawberry Image uploaded is an Bad Quality Product!`;
				el(
					'customers'
				).innerHTML = `Recommendation : Strawberries are of low to mediocre quality should avoid buying at a high price.
                                          Strawberries show many signs of abnormality such as bruises and blemishes.`;
				el(
					'vendors'
				).innerHTML = `Recommendation : Strawberries are of low to mediocre quality do not market at a high price and keep mark-up at a low.
				...
				el(
					'farmers'
				).innerHTML = `Recommendation : Strawberries are of low to mediocre quality should either be left to ripen for few more days to a week and added supervision.
